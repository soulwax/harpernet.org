      ...
      <main class="main">
        <div style="text-align: center; margin-bottom: 2rem;">
          ...
          <p style="max-width: 600px; margin: 0 auto; color: var(--text-secondary, #6b7280);">
            Journey through metaphorical landscapes to discover your cognitive metabolism. Each
            choice reveals patterns in how your mind processes and transforms information.
          </p>
        </div>
