  ...
  const features = [
    {
      ...
      route: '/sister-types',
      description:
        'Compare MBTI types with the same cognitive functions but different J/P preferences (e.g., INTP vs INTJ)',
      icon: '👯‍♀️',
      color: '#4CAF50',
    },
    {
      ...
      route: '/brother-types',
      description:
        'Compare types with the same functions but different E/I orientations (e.g., INTJ vs ENTJ)',
      icon: '🤝',
      color: '#2196F3',
    },
    {
    ...
    },
    {
      ...
      description:
        'Deep analysis with developmental stages, shadow manifestations, and positional dynamics',
      icon: '🔬',
      color: '#9C27B0',
    },
    {
    ...
    },
    {
      ...
      description:
        "Information processing framework integrating Jung's psychology with modern neuroscience",
      icon: '⚡',
      color: '#607D8B',
    },
    {
    ...
    <div class={styles.homeContainer}>
      ...
      <section class={styles.hero}>
        <div class={styles.heroContent}>
          ...
          <p class={styles.heroDescription}>
            Side-by-side comparisons, neuroscience research, and Jung's original framework combined
            with modern psychological practice and insight.
          </p>
        ...
        <div class={styles.methodologyGrid}>
          <div class={styles.methodCard}>
            ...
            <p>
              ...
              original conception of cognitive functions as manifestations, and his all-encompassing
              attempt at psychic energy flow and information processing patterns.
            </p>
          </div>
          ...
          <div class={styles.methodCard}>
            ...
            <p>
              Modern neuroscience research including fMRI studies, EEG research, and brain network
              analysis that tend to validate Jung's theoretical framework with empirical evidence,
              which is suprirising, considering these are tests found on bus magazines.
            </p>
          </div>
          ...
          <div class={styles.methodCard}>
            ...
            <p>
              ...
              approach possibilities, hoping to provided practical application for personal
              development and maybe why your relationship is like polishing the brass on the
              titanic. But we all go down.
            </p>
          </div>
          ...
          <div class={styles.methodCard}>
            ...
            <p>
              Uses systematic side-by-side comparison, focusing on functional differences rather
              than surface behaviors, a revelation for underlying cognitive current and architecture
              of of people and their "types".
            </p>
          </div>
        </div>
      </section>
        ...
        <div class={styles.sourceCategories}>
          <div class={styles.sourceCategory}>
            ...
            <ul class={styles.sourceList}>
              <li>
                Jung, C.G. - <em>Psychological Types</em> (Collected Works Vol. 6, 1921)
              </li>
              <li>
                Jung, C.G. - <em>On Psychic Energy</em> (Collected Works Vol. 8)
              </li>
              <li>
                Myers, Isabel Briggs & Briggs, Katherine Cook - <em>Gifts Differing</em>
              </li>
              <li>
                Kępiński, Antoni - <em>Information Metabolism Theory</em> (1974)
              </li>
            </ul>
          </div>
        ...
        <div class={styles.capabilitiesGrid}>
          <div class={styles.capabilityGroup}>
            ...
            <ul>
              ...
              <li>
                Understand shadow manifestations and blind spots which should help with shadow
                integration.
              </li>
          ...
          <div class={styles.capabilityGroup}>
            ...
            <ul>
              <li>
                Access evidence based neuroscientific validations of cognitive functions. They exist
                as imaging of brains has shown.
              </li>
        ...
        <div class={styles.quickStartSteps}>
          <div class={styles.step}>
            ...
            <div class={styles.stepContent}>
              ...
              <p>
                Compare types with shared and disparate cognitive function types who, on the
                surface, seem similar, in order to get the idea about how they see life.
              </p>
            </div>
          </div>
          ...
          <div class={styles.step}>
            ...
            <div class={styles.stepContent}>
              ...
              <p>
                Explore the eight functions in detail with developmental stages and applications
              </p>
            </div>
          </div>
          ...
          <div class={styles.step}>
            ...
            <div class={styles.stepContent}>
              ...
              <p>
                Attempt at integration of Jung's analytical psychology with evidence based
                methodologies.
              </p>
            </div>
          </div>
      ...
      <section class={styles.disclaimerSection}>
        ...
        <div class={styles.disclaimerContent}>
          <p>
            <strong>Educational Purpose Only:</strong> The stuff provided on here is for educational
            and research purposes. While based. On established psychological theory and some
            contemporary research, personality type analysis should not be considered a substitute
            for professional psychological assessment or counseling. I seriously hope you guys don't
            do this.
          </p>

          <p>
            <strong>No Guarantee of Accuracy:</strong> I make no claims regarding the absolute and
            infallible accuracy of personality type determination or prediction provided on here.
            Individual personality is complex and multifaceted, and type theory represents one
            framework among many for understanding human differential psychology a bit better. It
            usually correlates well with the evidence based and lexical OCEAN (or "Big5").
          </p>

          <p>
            <strong>Personal Responsibility:</strong> You! assume full responsibility for how you
            interpret and apply this information. I assume no liability for any personal,
            professional, or interpersonal consequences arising from the use of providing the info
            on here.
          </p>
          ...
          <p>
            ...
            health professionals even though I personally hate most shrinks (opinion, they can
            help), than relying solely on personality type analysis.
          </p>
        </div>
      </section>
    </div>
